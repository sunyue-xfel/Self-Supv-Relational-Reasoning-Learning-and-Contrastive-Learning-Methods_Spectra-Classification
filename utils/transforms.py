...
class CutPiece:
    ...
    def forward(self, data):
        ...
        return cut_piece(data, self.sigma,self.typeC)
...
class Cut_One_Piece:
    ...
    def forward(self, data):
        ...
        return cut_one_piece(data, self.piece_len)
...
#         print('timewarp input shape',data.shape)
        return time_warp_s_yue(data, sigma=self.sigma, knot=self.knot)
...
#             print('transform.Compose:',img.shape,t)
            img = t(img)
